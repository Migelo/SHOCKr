...
std::vector<double> RiemannSolverHLLC::numericalFlux(std::vector<double>& quantitiesLeft, std::vector<double>& quantitiesRight)
{
  ...
  double rhoV2Left =
      quantitiesLeft[EquationsEuler::XMOM] * quantitiesLeft[EquationsEuler::XMOM] / quantitiesLeft[EquationsEuler::DENS];
  double rhoV2Right =
      quantitiesRight[EquationsEuler::XMOM] * quantitiesRight[EquationsEuler::XMOM] / quantitiesRight[EquationsEuler::DENS];
  ...
  sStar  = (pRight - pLeft + quantitiesLeft[EquationsEuler::XMOM] * (sLeft - uLeft) -
           quantitiesRight[EquationsEuler::XMOM] * (sRight - uRight)) /
  ...
  else if((sLeft <= 0) && (sStar >= 0))
    {
      ...
      quantitiesLeftStar[EquationsEuler::ENERGY] =
          ...
          (quantitiesLeft[EquationsEuler::ENERGY] / quantitiesLeft[EquationsEuler::DENS] +
           (sStar - uLeft) * (sStar + pLeft / (quantitiesLeft[EquationsEuler::DENS] * (sLeft - uLeft))));
  ...
  else if((sStar <= 0) && (sRight >= 0))
    {
      ...
      quantitiesRightStar[EquationsEuler::ENERGY] =
          ...
          (quantitiesRight[EquationsEuler::ENERGY] / quantitiesRight[EquationsEuler::DENS] +
           (sStar - uRight) * (sStar + pRight / (quantitiesRight[EquationsEuler::DENS] * (sRight - uRight))));
